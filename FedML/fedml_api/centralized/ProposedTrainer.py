    ...
    def train(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            for i_batch, sampled_batch in enumerate(self.train_global):
                ...
                input_volume_batch = torch.cat([labeled_volume_batch, batch_ux_mixed, weak_unlabeled_volume_batch, str_unlabeled_volume_batch], dim=0)

                # input_data = torch.cat([ labeled_volume_batch, batch_ux_mixed, weak_unlabeled_volume_batch, str_unlabeled_volume_batch], dim=0)
                ...
                mixup_loss = self.dice_loss(outputs_soft[1:2], batch_pred_mixed_one_encod.unsqueeze(1)) 
                ...
                consistency_loss = mixup_loss +  Fix_loss
