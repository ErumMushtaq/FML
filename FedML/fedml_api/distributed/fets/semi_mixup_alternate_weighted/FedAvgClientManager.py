...
class FedAVGClientManager(ClientManager):
    ...
    def send_model_to_server(self, receive_id, weights, local_sample_num, train_loss):
    ...
    def __train(self):
        ...
        weights, local_sample_num, train_loss = self.trainer.train(self.round_idx)
        self.send_model_to_server(0, weights, local_sample_num, train_loss)
