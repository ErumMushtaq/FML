...
class FedAVGAggregator(object):
    ...
    def aggregate(self):
        ...
        for idx in range(self.worker_num):
            ...
            model_list.append((self.sample_num_dict[idx], self.model_dict[idx],self.weight_[idx]))
        ...
        for k in averaged_params.keys():
            for i in range(0, len(model_list)):
                local_sample_number, local_model_params, local_weight = model_list[i]
                print(f'model index: {i}, local weight: {local_weight}')
