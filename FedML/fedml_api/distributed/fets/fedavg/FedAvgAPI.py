...
from .FedFeTS_Trainer import FedAvgTrainer_
...
def FedML_FedAvg_distributed(process_id, worker_number, device, comm, model, train_data_num, train_data_global,
    test_data_global, train_data_local_num_dict, train_data_local_dict, test_data_local_dict, args, test_data_num):
    model_trainer = FedAvgTrainer_(model, args)
    if process_id == 0:
