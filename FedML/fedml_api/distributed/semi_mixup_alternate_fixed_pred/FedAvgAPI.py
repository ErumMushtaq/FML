...
def FedML_FedAvg_distributed_alternate_fixed_pred(process_id, worker_number, device, comm, model, ema_model, train_data_num, train_data_global,
    ...
    model_trainer = FedAvgTrainer_(model, ema_model, loss, ltr, utr, vtr, args)
    if process_id == 0:
