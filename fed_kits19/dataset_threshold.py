...
from dataset_creation_scripts.nnunet_library.data_augmentations import transformations
...
class KiTS19Raw(Dataset):
    ...
    """
    def __init__(self, train = True, X_dtype=torch.float32, y_dtype=torch.float32,  debug=False):
        ...
        self.tr_transform, self.test_transform = transformations(data_aug_params['patch_size_for_spatialtransform'],
                                                                 data_aug_params)
        ...
        df = pd.read_csv('../metadata/four_thresholded_sites.csv')
...
if __name__ == "__main__":
    train_dataset = FedKiTS19(5, train=True, pooled=False,)
