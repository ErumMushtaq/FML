...
#sh validation_.sh 1 1 1 nnunet 3000 1 0.0003 kits19 1 0 train 550 0
#sh validation_.sh 1 1 1 nnunet 3000 1 0.0003 kits19 1 0 train 600 0 

# scripts
#sh validation_.sh 1 1 1 nnunet 3000 1 0.0003 kits19 0 0 train 1103 0
...
mpirun -np 1 -hostfile ./mpi_host_file python3 ./validation.py \
