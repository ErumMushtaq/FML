...
from dataset_creation_scripts.paths import *
...
from dataset_creation_scripts.nnunet_library.experiment_planning.DatasetAnalyzer import DatasetAnalyzer
    ...
    if planner_name3d is not None:
        ...
        if planner_3d is None:
            raise RuntimeError("Could not find the Planner class %s. Make sure it is located somewhere in "
                               "nnunet_library.experiment_planning" % planner_name3d)
    else:
        planner_3d = None
    #
    # if planner_name2d is not None:
    #     planner_2d = recursive_find_python_class([search_in], planner_name2d, current_module="nnunet_library.experiment_planning")
    #     if planner_2d is None:
    #         raise RuntimeError("Could not find the Planner class %s. Make sure it is located somewhere in "
    #                            "nnunet_library.experiment_planning" % planner_name2d)
    # else:
    #     planner_2d = None
