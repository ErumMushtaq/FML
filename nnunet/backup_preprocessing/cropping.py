...
def crop_to_nonzero(data, seg=None, nonzero_label=-1):
    ...
    :return:
    """
    # print('data_preprocessing shape before cropping ')
    # print(data.shape)
    ...
    if seg is not None:
        ...
        seg = nonzero_mask
    # print('data_preprocessing shape After cropping ')
    # print(data.shape)
...
class ImageCropper(object):
    ...
    def load_crop_save(self, data, seg, case_identifier, overwrite_existing=False):
        try:
            print(case_identifier)
            data, seg, properties = self.crop_from_list_of_files(data, seg)
    ...
    def run_cropping(self, data_files, seg_files, case_identifier):
        """
        ...
        :return:
        """
        data, seg = self.load_crop_save(data_files, seg_files, case_identifier, overwrite_existing=False)
