...
from nnunet.backup_preprocessing.cropping import get_case_identifier_from_npz, ImageCropper
...
class GenericPreprocessor(object):
    ...
    def _run_internal(self, target_spacing, case_identifier, output_folder_stage, data, seg, properties, force_separate_z,
                      all_classes):
        # data, seg, properties = self.load_cropped(croppd_output_dir, case_identifier)
